...
- Now supports 1s timeframe + 10min timeframe independently
"""
...
SYMBOL_TF_MAP = {
    ...
    "V10": [300, 600],      # 5min + 10min
    "V25": [300, 600],      # 5min + 10min
    "V50": [300, 600],      # 5min + 10min
    "V75": [300, 600],      # 5min + 10min
    "Jump10": [300, 600],   # 5min + 10min
    "Jump25": [300, 600],   # 5min + 10min
    "Jump75": [300, 600],    # 5min + 10min
    "Jump50": [300, 600],   # 5min + 10min
    "Jump100": [300, 600],  # 5min + 10min
...
def create_signal_chart(signal_data):
    ...
    # Title with MA arrangement info and timeframe
